    ...
    public partial class Freitext {
        ...
        public override string? AdditionalSQLFilter {
            get {
                ...
                return $"{nameof(Freitext)}.{nameof(xtUsergroup_FK)} = {Database.CurrentUser.Usergroups.First().xtUsergroup_ID}";
            }
        }
        ...
        public override List<PropertyInfo> EditableProperties {
            get {
                ...
                if (!Database.CurrentUser.IsAdmin()) {
                    list.RemoveAll(l => l.Name == nameof(Freitext_ID));
