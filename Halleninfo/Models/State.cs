    ...
    public partial class State {
        public override Permission Permission {
            get {
                ...
                if (Database.CurrentUser.Usergroups.Contains(xtUsergroup)) return Permission.Read | Permission.Change | Permission.New;
        ...
        public override string? AdditionalSQLFilter {
            get {
                ...
                return $"{nameof(State)}.{nameof(xtUsergroup_FK)} = {Database.CurrentUser.Usergroups.First().xtUsergroup_ID}";
            }
        }
